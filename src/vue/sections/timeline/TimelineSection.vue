    ...
    <ul class="timeline">
      ...
      >
        ...
        <div
          ...
          :class="{ 'timeline-item-logo-bg-primary': !(item.place && item.place.logoUrl) }"
        >
          <!-- If item has an image... -->
          <ImageView
            v-if="item.place && item.place.logoUrl"
