 ...
 * @private
 */
function _getNavTabClassList(category) {
 ...
 * @private
 */
function _onLinkClicked(category) {
...
<template>
  <div class="nav-tabs-wrapper">
    <nav class="nav-tabs">
      <!-- Nav Tab Item -->
      <button
        v-for="category in data.getCategories()"
        :key="category.id"
      ...
      >
        <!-- Item Content -->
        <i
          class="nav-tab-button-icon"
          :class="category.faIcon"
        />
