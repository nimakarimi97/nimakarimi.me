...
const classList = computed(() => {
  return (
    constants.HTML_CLASSES.imageViewImage
    + (props.ignoreOnImageCount ? ` ${constants.HTML_CLASSES.imageViewImageIgnoredOnCount}` : '')
  )
})
 ...
 * @private
 */
function _setLoadStatus(status) {
