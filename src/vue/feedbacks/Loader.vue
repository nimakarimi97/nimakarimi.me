 ...
 */
function run(_message, _imageUrl) {
 ...
 */
function setTaskProgress(progressPercentage) {
 ...
 * @private
 */
function _didReachStep(animationStepLabel) {
...
<template>
  ...
  >
    <div
      v-show="_didReachStep('logoTweenIn')"
      class="loader-full-screen-content"
    >
      <!-- Logo -->
      <ImageView
        ref="logo"
