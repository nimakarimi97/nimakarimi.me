 ...
 */
function _onNavigationModeChanged(previousActiveSectionId) {
  const feedbackView = layout.getFeedbackView()
 ...
 * @private
 */
function _navigateToCategory(categoryId) {
...
<template>
  <div class="resume">
    ...
    <div
      ...
      :class="navigation.isSidebarExpanded() ? '' : 'sidebar-column-shrink'"
    >
      <!-- Sidebar -->
